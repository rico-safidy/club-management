...
@section('content')
    ...
    <main class="team-add">
        <h2 class="subtitle-primary team-add-subtitle">Ajouter une taille</h2>
        <form action="{{ Route('insert_size') }}" class="form team-add-form" method="POST">
            @csrf
            <div class="team-add-content">
                <h3 class="subtitle-primary team-add-main-content-title">Information de la taille</h3>
                @if ($errors)
                ...
                <div class="team-add-form-main">
                    <div class="team-add-form-desc">
                        <div class="form-content">
                            ...
                            <input type="text" name="size" id="category" class="form-input" placeholder="Taille">
                        </div>
                    </div>
