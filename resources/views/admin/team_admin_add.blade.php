...
@section('content')
    <main class="team-add">
        <h2 class="subtitle-primary team-add-subtitle">Ajouter un Joueur</h2>
        @if ($errors)
            @foreach ($errors->all() as $error)
                <p style="color: #e42d2d">{{ $error }}</p>
            @endforeach
        @endif
        <form action="{{ Route('insert_team') }}" class="form team-add-form" enctype="multipart/form-data" method="POST">
            @csrf
                ...
                <div class="team-add-content">
                    ...
                    <div class="login-main-content">
                        ...
                        <div class="form-content">
                            ...
                            <input type="number" name="number" id="" class="form-input" placeholder="Numero">
                        </div>
                    </div>
